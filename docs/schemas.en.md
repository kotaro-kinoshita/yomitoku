...
| ocr_vis | `np.array` \| `None` | Visualization of the OCR module (Only when `visualizer=True`) |
| layout_vis | `np.array` \| `None` | Visualization of the Layout Analyzer module (Only when `visualizer=True`) |
...
| ocr_vis | `np.array` \| `None` | Visualization of the AI-OCR module (Only when `visualizer=True`) |
