...
def main():
    parser = argparse.ArgumentParser(
        description="Extract structured data from document images using LLM"
    )
    parser.add_argument(
        "input",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="LLM model name (e.g. vLLM model)",
    )
    parser.add_argument(
        "--api-base",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Extract from a specific table only (e.g. t0)",
    )
    parser.add_argument(
        "--temperature",
        type=float,
    ...
    parser.add_argument(
        "--prompt-only",
        action="store_true",
        help="Print prompt and exit (for debugging)",
    )
    parser.add_argument(
        "--pages",
        type=str,
