...
## [v0.10.2](https://github.com/kotaro-kinoshita/yomitoku/tree/v0.10.2) (2025-12-01)

[Full Changelog](https://github.com/kotaro-kinoshita/yomitoku/compare/v0.10.1...v0.10.2)

**Implemented enhancements:**

- python 3.13のサポート [\#182](https://github.com/kotaro-kinoshita/yomitoku/pull/182) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))

**Merged pull requests:**

- pytorchのバージョンの変更に伴うREADMEの修正 [\#183](https://github.com/kotaro-kinoshita/yomitoku/pull/183) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- ドキュメントの軽微な修正 [\#181](https://github.com/kotaro-kinoshita/yomitoku/pull/181) ([m5t0](https://github.com/m5t0))
...
## [v0.10.1](https://github.com/kotaro-kinoshita/yomitoku/tree/v0.10.1) (2025-11-05)

[Full Changelog](https://github.com/kotaro-kinoshita/yomitoku/compare/v0.9.5...v0.10.1)

**Implemented enhancements:**

- Text Recognizer Tinyの実装 [\#172](https://github.com/kotaro-kinoshita/yomitoku/pull/172) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- Searchable-PDFの容量の削減 [\#170](https://github.com/kotaro-kinoshita/yomitoku/pull/170) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- CLIにて読み取り対象のページの指定オプションの追加 [\#162](https://github.com/kotaro-kinoshita/yomitoku/pull/162) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- モデルのダウンロードコマンドの実装 [\#159](https://github.com/kotaro-kinoshita/yomitoku/pull/159) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- PDFを画像化するときのDPIの設定オプションをCLIに導入 [\#140](https://github.com/kotaro-kinoshita/yomitoku/pull/140) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))

**Fixed bugs:**

- CHANGELOGの自動生成CIの修正 [\#166](https://github.com/kotaro-kinoshita/yomitoku/pull/166) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- Fix/pr feedback [\#150](https://github.com/kotaro-kinoshita/yomitoku/pull/150) ([Utakata](https://github.com/Utakata))
...
[Full Changelog](https://github.com/kotaro-kinoshita/yomitoku/compare/v0.13.0...HEAD)

**Implemented enhancements:**

- Feature/ar repetition early stop [\#223](https://github.com/kotaro-kinoshita/yomitoku/pull/223) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- docs: add prohibition on use for developing competing models to usage… [\#220](https://github.com/kotaro-kinoshita/yomitoku/pull/220) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
...
- PDFの遅延レンダリングに対して添字アクセス機能を追加 [\#208](https://github.com/kotaro-kinoshita/yomitoku/pull/208) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- Searchable-PDFで出力の品質オプションを追加 [\#206](https://github.com/kotaro-kinoshita/yomitoku/pull/206) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- load\_pdfを遅延レンダリング方式に変更しOOMを防止 [\#202](https://github.com/kotaro-kinoshita/yomitoku/pull/202) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- ExtractorにおいてKeyに対して複数値が存在する場合のマージオプションの追加 [\#199](https://github.com/kotaro-kinoshita/yomitoku/pull/199) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))

**Fixed bugs:**

- オリエンテーションフォールバックのデフォルト値の変更 [\#204](https://github.com/kotaro-kinoshita/yomitoku/pull/204) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))

## [v0.12.0](https://github.com/kotaro-kinoshita/yomitoku/tree/v0.12.0) (2026-03-04)

[Full Changelog](https://github.com/kotaro-kinoshita/yomitoku/compare/v0.11.0...v0.12.0)

**Implemented enhancements:**

- テキスト認識モデルの回転テキストに対するフォールバック処理の実装 [\#196](https://github.com/kotaro-kinoshita/yomitoku/pull/196) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- implement ignore\_ruby option [\#194](https://github.com/kotaro-kinoshita/yomitoku/pull/194) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- Text Recognizer Tinyの実装 [\#172](https://github.com/kotaro-kinoshita/yomitoku/pull/172) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- Searchable-PDFの容量の削減 [\#170](https://github.com/kotaro-kinoshita/yomitoku/pull/170) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- CLIにて読み取り対象のページの指定オプションの追加 [\#162](https://github.com/kotaro-kinoshita/yomitoku/pull/162) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- モデルのダウンロードコマンドの実装 [\#159](https://github.com/kotaro-kinoshita/yomitoku/pull/159) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
...
- Feature/model catalog [\#12](https://github.com/kotaro-kinoshita/yomitoku/pull/12) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
...
- Key-Value Paserのアルゴリズムの修正 [\#198](https://github.com/kotaro-kinoshita/yomitoku/pull/198) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- CHANGELOGの自動生成CIの修正 [\#166](https://github.com/kotaro-kinoshita/yomitoku/pull/166) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- Fix/pr feedback [\#150](https://github.com/kotaro-kinoshita/yomitoku/pull/150) ([Utakata](https://github.com/Utakata))
- \[TYPO\] ドキュメントの誤字・誤りを修正 [\#133](https://github.com/kotaro-kinoshita/yomitoku/pull/133) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
- ドキュメントのビルドワークフローの修正 [\#128](https://github.com/kotaro-kinoshita/yomitoku/pull/128) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
...
- ライセンス情報の記載 [\#53](https://github.com/kotaro-kinoshita/yomitoku/pull/53) ([kotaro-kinoshita](https://github.com/kotaro-kinoshita))
